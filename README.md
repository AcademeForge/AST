...
<p>
  If the button doesn’t work, copy and paste the UPI ID: 
  <code style="color: inherit; text-decoration: none; font-family: monospace; background: none; padding: 0; border: none;">
    devrajkumar01@ybl
  </code> 
  in your UPI app.
</p>
